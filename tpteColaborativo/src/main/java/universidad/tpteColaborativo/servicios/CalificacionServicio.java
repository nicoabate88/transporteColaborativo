...
public class CalificacionServicio {
    ...
    public ArrayList<Calificacion> buscarCalificacionConductor(Long idConductor) {

        System.out.println("Id Usuario conducotr " + idConductor);

        return calificacionRepositorio.buscarCalificacionConductor(idConductor);

    }

    public ArrayList<Calificacion> buscarCalificacionViajero(Long idViajero) {

        return calificacionRepositorio.buscarCalificacionViajero(idViajero);
